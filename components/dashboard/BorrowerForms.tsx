    ...
    <form onSubmit={handleSubmit} className="workspace-form">
      ...
      {error && <p className="workspace-error">{error}</p>}
        ...
        <button
          ...
          className="workspace-button workspace-button--primary"
          style={{ width: "100%", marginTop: "0.5rem", display: "inline-flex", justifyContent: "center", alignItems: "center" }}
        >
          {loading && (
            <svg className="mr-2 h-4 w-4 animate-spin" style={{ marginRight: "0.5rem" }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
