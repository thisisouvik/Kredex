...
| Sangram Sen | GALKUNV3QKBIP37JCQXXDOCZBRKBCA52JRCOH2442GHSRHOWG3RPPWTL | Lender | I tried the KYC feature | KYC can be done in a better way | KYC asking same question make it one time | `[Commit-G]` / `[Commit-I]` |
| Vansh Dhiwar | GBFQZ6B257O6L5IQ523ZA33QGGL5DKEJEXEPNZS56F7YZDKJUK2WH23W | Lender | The walkthorugh feature | not that i can think of | maybe add a light dark mode toggle | `[Commit-F]` |
